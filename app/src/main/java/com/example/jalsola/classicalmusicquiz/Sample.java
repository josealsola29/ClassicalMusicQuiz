package com.example.jalsola.classicalmusicquiz;
...
public class Sample {
    ...
    public Sample(int mSampleID, String mComposer, String mTitle, String mUri, String mAlbumArtID) {
    ...
    private static JsonReader readJSONFile(Context context) throws IOException {
        ...
        try {
            ...
            Toast.makeText(context, R.string.sample_list_load_error, Toast.LENGTH_LONG).show();
        }
    ...
    public void setComposer(String mComposer) {
        this.mComposer = mComposer;
    }
